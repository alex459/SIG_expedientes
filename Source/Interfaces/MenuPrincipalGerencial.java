 ...
 * @author Kevin
 */
public class MenuPrincipalGerencial extends javax.swing.JFrame {

    /**
     * Creates new form MenuPrincipalGerencial
     */
    public MenuPrincipalGerencial() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuPrincipalGerencial.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuPrincipalGerencial().setVisible(true);
            }
        });
    }
